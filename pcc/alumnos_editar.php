                    ...
                    <div class="col-lg-12">
                        ...
                        <form role="form" method="POST" action="alumnos_grabar.php">
                            ...
                            <fieldset class="form-group">
                                ...
                                <input type="date" class="form-control" required="required" name="fec_nac_per" value=<?php echo $fila['fec_nac_per']; ?> id="fec_nac_per">
                            </fieldset>
                        ...
                        if ($fila["sex_per"]=="M") {
                            ...
                            <fieldset class="form-group">
                                ...
                                <input type="email" class="form-control" placeholder="Escriba su Correo Electrónico:" required="required" value=<?php echo $fila['email_per']; ?> name="email_per" value=<?php echo $fila['email_per']; ?> id="email_per" maxlength="50">
                            </fieldset>
                            ...
                            <fieldset class="form-group">
                                ...
                                <input class="form-control" placeholder="Cree un usuario para acceder al sistema:" required="required" name="log_per" value=<?php echo $fila['log_per']; ?> id="log_per" maxlength="100">
                            </fieldset>

                            <fieldset class="form-group">
                                <label for="pass_per">Contraseña:</label>
                                <input type="password" class="form-control" placeholder="Cree una contraseña para acceder al sistema:" required="required" name="pass_per" value=<?php echo $fila['pass_per']; ?> id="pass_per" maxlength="100">
                            </fieldset>
