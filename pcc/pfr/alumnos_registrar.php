                    ...
                    <div class="col-lg-12">
                        <form role="form" method="POST" action="alumnos_grabar.php">
                            ...
                            <fieldset class="form-group">
                                ...
                                <input class="form-control" type="date" required="required" name="fec_nac_per" id="fec_nac_per">
                            </fieldset>
                            ...
                            <fieldset class="form-group">
                                ...
                                <input  type="email" class="form-control" placeholder="Escriba su Correo Electronico" required="required" name="email_per" id="email_per" maxlength="50">
                            </fieldset>

                            <fieldset class="form-group">
                                <label for="cel_per">Celular: </label>
                                <input class="form-control" placeholder="Escriba su celular" required="required" name="cel_per" id="cel_per">
                            </fieldset>

                            <fieldset class="form-group">
                                <label for="dir_per">Direccion: </label>
                                <input class="form-control" placeholder="Escriba su direccion" required="required" name="dir_per" id="dir_per">
                            </fieldset>
                            ...
                            <fieldset class="form-group">
                                ...
                                <input class="form-control" placeholder="Cree una contraseña"  name="pass_per" id="pass_per" maxlength="45">
                            </fieldset>
